(function () {
      ...
      for (let i = 0; i < a; i++) {
        ...
        for (let i in a)
          if (a.hasOwnProperty(i)) {
            const o = a[i];
            if (s && (Array.isArray(o) || e(o))) {
              const e = Array.isArray(o) ? [] : {};
              n[i] = t(!0, n.hasOwnProperty(i) ? n[i] : e, o);
            } else n[i] = o;
          }
      }
      return n;
      ...
      (this._element = e),
        ...
        (this._move = (e) => {
          const t = this.currentPointers.slice(),
            i =
              "changedTouches" in e
                ? Array.from(e.changedTouches).map((e) => new o(e))
                : [new o(e)];
          for (const e of i) {
  ...
  class c {
    ...
    on(t, i) {
      ...
      return (
        String(t)
          .split(" ")
          .forEach((e) => {
            const t = (this.events[e] = this.events[e] || []);
    ...
    once(t, i) {
      ...
      return (
        String(t)
          ...
          .forEach((e) => {
            const t = (...s) => {
              this.off(e, t), i.call(this, this, ...s);
            };
            (t._ = i), this.on(e, t);
          }),
        this
    ...
    attachPlugins(e) {
      ...
      for (const [s, n] of Object.entries(e || {}))
        !1 === this.options[s] ||
          this.plugins[s] ||
          ((this.options[s] = t({}, n.defaults || {}, this.options[s])),
          (i[s] = new n(this)));
      for (const [e, t] of Object.entries(i)) t.attach(this);
    ...
    constructor(e = {}) {
      (this.options = t(!0, {}, e)), (this.plugins = []), (this.events = {});
  ...
  class h extends c {
        ...
        move: (t, i, s) => {
          ...
          if ("xy" === p || "y" !== this.lockAxis) {
            if (
              ...
              const t = r(e.startPointers[0], e.startPointers[1]),
    ...
    updateMetrics(e) {
      ...
      let u =
        ...
        ((p = s),
        Math.max(
          parseFloat(p.naturalHeight || 0),
          parseFloat(
            (p.height && p.height.baseVal && p.height.baseVal.value) || 0
          ),
          parseFloat(p.offsetHeight || 0),
          parseFloat(p.scrollHeight || 0)
        ));
      var p;
      ...
      (d = i(d * f)), (u = i(u * f)), (l = d), (c = u);
      const g = s.getBoundingClientRect(),
        m = n.getBoundingClientRect(),
        v = n == t ? m : t.getBoundingClientRect();
      let b = Math.max(n.offsetWidth, i(m.width)),
        y = Math.max(n.offsetHeight, i(m.height)),
        x = window.getComputedStyle(n);
      if (
        ((b -= parseFloat(x.paddingLeft) + parseFloat(x.paddingRight)),
        (y -= parseFloat(x.paddingTop) + parseFloat(x.paddingBottom)),
        (this.viewport.width = b),
        (this.viewport.height = y),
        a)
      ) {
        if (Math.abs(d - g.width) > 0.1 || Math.abs(u - g.height) > 0.1) {
          const e = ((e, t, i, s) => {
            const n = Math.min(i / e || 0, s / t);
            return { width: e * n || 0, height: t * n || 0 };
          })(d, u, Math.min(d, g.width), Math.min(u, g.height));
          (l = i(e.width)), (c = i(e.height));
        }
        Object.assign(s.style, {
          width: `${l}px`,
          height: `${c}px`,
      ...
      if (
        (r &&
          (Object.assign(n.style, { width: `${l}px`, height: `${c}px` }),
    ...
    zoomTo(e = this.option("baseScale"), { x: t = null, y: s = null } = {}) {
      e = Math.max(
      ...
      const { deltaX: o, deltaY: a } = this.getZoomDelta(e, t, s);
      (t = this.content.x - o),
        (s = this.content.y - a),
        this.panTo({
          x: t,
    ...
    getBounds(e) {
      let t = this.boundX,
        s = this.boundY;
      if (void 0 !== t && void 0 !== s) return { boundX: t, boundY: s };
      (t = { from: 0, to: 0 }),
        (s = { from: 0, to: 0 }),
        (e = e || this.transform.scale);
      const n = this.content.fitWidth * e,
    ...
    setTransform(e) {
      ...
      if (
        (e
          ? ((t = i(this.transform.x)),
            (s = i(this.transform.y)),
            (n = this.transform.scale),
            (this.content = { ...this.content, x: t, y: s, scale: n }))
          : ((t = i(this.content.x)),
            (s = i(this.content.y)),
            (n =
              this.content.scale /
              (this.content.width / this.content.fitWidth)),
            (this.content = { ...this.content, x: t, y: s })),
        ...
        let e, o;
        (e = i(this.content.fitWidth * n)),
          (o = i(this.content.fitHeight * n)),
          ...
          Object.assign(this.$content.style, {
            ...
            maxWidth: "none",
            maxHeight: "none",
            transform: `translate3d(${t}px, ${s}px, 0) scale(1)`,
          });
      } else
        this.$content.style.transform = `translate3d(${t}px, ${s}px, 0) scale(${n})`;
    ...
    constructor(e, i = {}) {
      super(t(!0, {}, d, i)), (this.state = "init"), (this.$container = e);
  ...
  class v extends c {
    ...
    initSlides() {
      (this.slides = []),
        ...
        Array.isArray(this.options.slides) &&
          (this.slides = t(!0, [...this.slides], this.options.slides));
    }
    updateMetrics() {
      let e,
        t = 0,
      ...
      this.slides.forEach((i, n) => {
        const o = i.$el,
          a = i.isDom || !e ? this.getSlideMetrics(o) : e;
        (i.index = n),
          (i.width = a),
          (i.left = t),
          (e = a),
      ...
      (n -= parseFloat(o.paddingLeft) + parseFloat(o.paddingRight)),
        (this.contentWidth = t),
        (this.viewportWidth = n);
      const a = [],
        r = this.option("slidesPerPage");
      if (Number.isInteger(r) && t > n)
        for (let e = 0; e < this.slides.length; e += r)
          a.push({
            indexes: s.slice(e, e + r),
        ...
        for (let i = 0; i < this.slides.length; i += 1) {
          let s = this.slides[i];
          (!a.length || t + s.width > n) &&
            (a.push({ indexes: [], slides: [] }), (e = a.length - 1), (t = 0)),
            (t += s.width),
            a[e].indexes.push(i),
            a[e].slides.push(s);
        }
      ...
      a.forEach((e, i) => {
        (e.index = i),
          ...
          l && (e.left += 0.5 * (n - e.width) * -1),
          c &&
            !this.option("infiniteX", this.option("infinite")) &&
            t > n &&
            ((e.left = Math.max(e.left, 0)),
            (e.left = Math.min(e.left, t - n)));
      });
      const d = [];
      let h;
      a.forEach((e) => {
        ...
        h && t.left === h.left
          ? ((h.width += t.width),
            (h.slides = [...h.slides, ...t.slides]),
            (h.indexes = [...h.indexes, ...t.indexes]))
          : ((t.index = d.length), (h = t), d.push(t));
      }),
        (this.pages = d);
      let u = this.page;
      if (null === u) {
        ...
        (u =
          ...
          d[u] || (u = d.length && u > d.length ? d[d.length - 1].index : 0),
          (this.page = u),
          (this.pageIndex = u);
      }
    ...
    getSlideMetrics(e) {
      ...
      let t = Math.max(e.offsetWidth, i(e.getBoundingClientRect().width));
      const s = e.currentStyle || window.getComputedStyle(e);
      return (
        (t =
          t +
    ...
    initPanzoom() {
      ...
      (this.Panzoom = new h(this.$container, e)),
        this.Panzoom.on({
    ...
    w = (e) => {
      if (e && b) {
        ...
        try {
          ...
          else if (y) e.focus({ preventScroll: !0 });
          else {
  ...
  class $ {
    ...
    processType(e) {
      ...
      const i = e.src || "";
      let s = e.type || this.fancybox.options.type,
        n = null;
      if (!i || "string" == typeof i) {
        if (
          ...
          const t = S(i, this.fancybox.option("Html.youtube")),
            o = encodeURIComponent(n[1]);
          (e.videoId = o),
            (e.src = `https://www.youtube-nocookie.com/embed/${o}?${t}`),
            (e.thumb = e.thumb || `https://i.ytimg.com/vi/${o}/mqdefault.jpg`),
            (e.vendor = "youtube"),
            (s = "video");
        } else if ((n = i.match(/^.+vimeo.com\/(?:\/)?([\d]+)(.*)?/))) {
          const t = S(i, this.fancybox.option("Html.vimeo")),
            o = encodeURIComponent(n[1]);
          (e.videoId = o),
            (e.src = `https://player.vimeo.com/video/${o}?${t}`),
            (e.vendor = "vimeo"),
            (s = "video");
        } else
          (n = i.match(
            ...
            : (n = i.match(
              ...
              ((e.src = `//maps.google.${n[1]}/maps?q=${n[2]
                .replace("query=", "q=")
        ...
        s ||
          ("#" === i.charAt(0)
            ? (s = "inline")
            : (n = i.match(/\.(mp4|mov|ogv|webm)((\?|#).*)?$/i))
            ? ((s = "html5video"),
              (e.format =
                e.format || "video/" + ("ogv" === n[1] ? "ogg" : n[1])))
            : i.match(
                /(^data:image\/[a-z0-9+\/=]*,)|(\.(jp(e|g|eg)|gif|png|bmp|webp|svg|ico)((\?|#).*)?$)/i
              )
            ? (s = "image")
            : i.match(/\.(pdf)((\?|#).*)?$/i) && (s = "pdf")),
          (e.type = s || this.fancybox.option("defaultType", "image")),
          ("html5video" !== s && "video" !== s) ||
            ((e.video = t({}, this.fancybox.option("Html.video"), e.video)),
            e._width && e._height
              ? (e.ratio = parseFloat(e._width) / parseFloat(e._height))
              : (e.ratio = e.ratio || e.video.ratio || E.video.ratio));
      }
    }
    onReady() {
  ...
  class T {
    ...
    initSlidePanzoom(e) {
      e.Panzoom ||
        ((e.Panzoom = new h(
          e.$el,
          t(!0, this.fancybox.option("Image.Panzoom", {}), {
            viewport: e.$wrap,
            content: e.$image,
            width: e._width,
            height: e._height,
  ...
  class P {
    ...
    static startFromUrl() {
      ...
      const { hash: t, slug: i, index: s } = P.getParsedURL();
      if (!i) return;
    ...
    static onHashChange() {
      const { slug: e, index: t } = P.getParsedURL(),
        i = P.Fancybox,
        s = i && i.getInstance();
      if (s && s.plugins.Hash) {
        if (e) {
    ...
    static create(e) {
      function t() {
        window.addEventListener("hashchange", P.onHashChange, !1),
          P.startFromUrl();
      }
      (P.Fancybox = e),
        b &&
    ...
    static destroy() {
      window.removeEventListener("hashchange", P.onHashChange, !1);
    }
    static getParsedURL() {
  ...
  const M = {
    ...
    items: {
      ...
      fullscreen: {
        ...
        click: function (e) {
          e.preventDefault(),
            L.element() ? L.deactivate() : L.activate(this.fancybox.$container);
        },
      },
      slideshow: {
        type: "button",
  ...
  class z {
    ...
    build() {
      ...
      for (const o of this.fancybox.option("Toolbar.display")) {
        let a, r;
        if (
          (e(o) ? ((a = o.id), (r = t({}, i[a], o))) : ((a = o), (r = i[a])),
  ...
  class N extends c {
    ...
    onClick(e) {
      ...
      if (
        !(t.matches(x) || document.activeElement.blur(),
    ...
    focus(e) {
      ...
      const n = Array.from(t.querySelectorAll(x));
      let o,
        a = [];
      for (let e of n) {
      ...
      e
        ...
        ? w(o)
        : a.indexOf(document.activeElement) < 0 && w(t),
    ...
    static fromOpener(e, i = {}) {
      let s = [],
        n = i.startIndex || 0,
        o = i.target || null;
      const a =
          void 0 !== (i = t({}, i, N.openers.get(e))).groupAll && i.groupAll,
        r = void 0 === i.groupAttr ? "data-fancybox" : i.groupAttr,
        l = r && o ? o.getAttribute(`${r}`) : "";
      if (!o || l || a) {
        const t = i.root || (o ? o.getRootNode() : document.body);
        s = [].slice.call(t.querySelectorAll(e));
      }
      if (
        (o &&
          !a &&
          (s = l ? s.filter((e) => e.getAttribute(`${r}`) === l) : [o]),
        !s.length)
      )
        return !1;
      const c = N.getInstance();
      return (
        !(c && s.indexOf(c.options.$trigger) > -1) &&
        ((n = o ? s.indexOf(o) : n),
        (s = s.map(function (e) {
        ...
        new N(s, t({}, i, { startIndex: n, $trigger: o })))
      );
    }
    static bind(e, t = {}) {
      function i() {
    ...
    static close(e = !0, t) {
      if (e) for (const e of _.values()) e.close(t);
      else {
  ...
  for (const [e, t] of Object.entries(N.Plugins || {}))
    "function" == typeof t.create && t.create(N);
  var B = {};
  !(function (e, t) {
    var i = (function (e, t, i) {
      ...
      var o = t.documentElement,
        ...
        $ =
          ...
          (we = function () {
            var e = xe;
            for (xe = be.length ? ye : be, me = !0, ve = !1; e.length; )
              e.shift()();
            me = !1;
          }),
          (Ce = function (e, i) {
            me && !i
              ...
              : (xe.push(e), ve || ((ve = !0), (t.hidden ? d : h)(we)));
          }),
          (Ce._lsFlush = we),
          Ce),
        T = function (e, t) {
        ...
        k =
          ...
          (ie = function (e) {
            return (
              null == X && (X = "hidden" == S(t.body, "visibility")),
              X ||
                !(
          ...
          (se = function (e, i) {
            ...
            for (
              G -= i, j += i, q -= i, V += i;
              a && (n = n.offsetParent) && n != t.body && n != o;

            )
              (a = (S(n, "opacity") || 1) > 0) &&
                "visible" != S(n, "overflow") &&
          ...
          (ne = function () {
            var e,
              ...
              m,
              v = s.elements;
            if ((F = n.loadMode) && Q < 8 && (e = v.length)) {
              for (i = 0, ee++; i < e; i++)
                if (v[i] && !v[i]._lazyRace)
                  if (!Z || (s.prematureUnveil && s.prematureUnveil(v[i])))
                    ue(v[i]);
                  else if (
                    (((u = v[i][l]("data-expand")) && (d = 1 * u)) || (d = J),
                    f ||
                      ((f =
                        !n.expand || n.expand < 1
                    ...
                    (j = a.bottom) >= h &&
                      ...
                      (j || V || q || G) &&
                      (n.loadHidden || ie(v[i])) &&
                      ((B && Q < 3 && !u && (F < 3 || ee < 4)) || se(v[i], d)))
                  ) {
                    if ((ue(v[i]), (c = !0), Q > 9)) break;
                  } else
                    !c &&
                      B &&
                      !r &&
          ...
          (he = T(function (e, t, i, s, o) {
            var a, r, c, h, u, f;
            (u = w(e, "lazybeforeunveil", t)).defaultPrevented ||
              (s && (i ? b(e, n.autosizesClass) : e.setAttribute("sizes", s)),
              (r = e[l](n.srcsetAttr)),
              (a = e[l](n.srcAttr)),
              o && (h = (c = e.parentNode) && p.test(c.nodeName || "")),
              (f = t.firesLoad || ("src" in e && (r || a || h))),
              (u = { target: e }),
              b(e, n.loadingClass),
              f && (clearTimeout(D), (D = d(te, 2500)), x(e, le, !0)),
              h && m.call(c.getElementsByTagName("source"), de),
              r
                ? e.setAttribute("srcset", r)
                : a && !h && (U.test(e.nodeName) ? ce(e, a) : (e.src = a)),
              o && (r || h) && C(e, { src: a })),
          ...
          (fe = function () {
            3 == n.loadMode && (n.loadMode = 2), pe();
          }),
          (ge = function () {
            B ||
              (i.now() - R < 999
                ? d(ge, 999)
                : ((B = !0), (n.loadMode = 3), oe(), c("scroll", fe, !0)));
          }),
          {
            _: function () {
              (R = i.now()),
                ...
                e.MutationObserver
                  ...
                  : (o[r]("DOMNodeInserted", oe, !0),
                    o[r]("DOMAttrModified", oe, !0),
                    setInterval(oe, 999)),
                c("hashchange", oe, !0),
                [
                  "focus",
                ...
                /d$|^c/.test(t.readyState)
                  ? ge()
                  : (c("load", ge), t[r]("DOMContentLoaded", oe), d(ge, 2e4)),
                s.elements.length ? (ne(), $._lsFlush()) : oe();
            },
            checkElems: oe,
            unveil: ue,
            _aLSL: fe,
        ...
        M =
          ((O = T(function (e, t, i, s) {
            ...
            if (
              ...
              for (
                o = 0, a = (n = t.getElementsByTagName("source")).length;
                o < a;
                o++
              )
          ...
          (_ = function (e, t, i) {
            ...
            n &&
              ((i = E(e, n, i)),
              (s = w(e, "lazybeforesizes", { width: i, dataAttr: !!t }))
                .defaultPrevented ||
                ((i = s.detail.width) &&
                  i !== e._lazysizesWidth &&
                  O(e, n, s, i)));
          ...
          (I = L(function () {
            var e,
              t = A.length;
            if (t) for (e = 0; e < t; e++) _(A[e]);
          })),
          {
            _: function () {
              (A = t.getElementsByClassName(n.autosizesClass)), c("resize", I);
            },
            checkElems: I,
            updateElem: _,
          }),
        z = function () {
          !z.i && t.getElementsByClassName && ((z.i = !0), M._(), k._());
        };
      var A, O, _, I;
      var N,
        B,
  ...
  function F(e = {}, t = {}) {
    Object.keys(t).forEach((i) => {
      void 0 === e[i]
        ? (e[i] = t[i])
        : D(t[i]) && D(e[i]) && Object.keys(t[i]).length > 0 && F(e[i], t[i]);
    });
  }
  const R = {
    body: {},
  ...
  const Z = {
    ...
    is: function (e) {
      ...
      if ("string" == typeof e) {
        ...
        for (n = X(e), o = 0; o < n.length; o += 1) if (n[o] === s) return !0;
        return !1;
      }
      if (e === i) return s === i;
      if (e === t) return s === t;
    ...
    parents: function (e) {
      ...
      for (let i = 0; i < this.length; i += 1) {
        ...
        for (; s; ) e ? X(s).is(e) && t.push(s) : t.push(s), (s = s.parentNode);
      }
      return X(t);
    },
    closest: function (e) {
          ...
          void 0 !== o &&
            ...
            (te(e[n]) && te(s[n])
              ? s[n].__swiper__
                ...
                : se(e[n], s[n])
              : !te(e[n]) && te(s[n])
              ? ((e[n] = {}), s[n].__swiper__ ? (e[n] = s[n]) : se(e[n], s[n]))
              : (e[n] = s[n]));
        }
      }
    }
  ...
  function oe(e) {
    ...
    const c = i > o ? "next" : "prev",
      ...
      h = () => {
        ...
        let u = o + c * (i - o);
        if ((d(u, i) && (u = i), t.wrapperEl.scrollTo({ [s]: u }), d(u, i)))
          return (
  ...
  function fe(e) {
    ...
    if (
      ...
      c.is(n.focusableElements) &&
        ...
        i.activeElement &&
          K(i.activeElement).is(n.focusableElements) &&
          i.activeElement !== c[0] &&
  ...
  function ge(e) {
    ...
    if (!i.allowTouchMove)
      return (
        K(l.target).is(s.focusableElements) || (i.allowClick = !1),
        void (
          s.isTouched &&
          (Object.assign(o, { startX: d, startY: h, currentX: d, currentY: h }),
          (s.touchStartTime = Q()))
        )
      );
    ...
    if (
      ...
      K(l.target).is(s.focusableElements)
    )
      ...
      update: {
        ...
        updateSlides: function () {
          ...
          "string" == typeof y &&
            ...
            s.centeredSlides &&
              s.cssMode &&
              (ne(e.wrapperEl, "--swiper-centered-offset-before", ""),
              ne(e.wrapperEl, "--swiper-centered-offset-after", ""));
          ...
          if (
            ...
            ne(e.wrapperEl, "--swiper-centered-offset-before", -u[0] + "px"),
              ne(
                e.wrapperEl,
          ...
          (t.clickedSlide = s),
            t.virtual && t.params.virtual.enabled
              ? (t.clickedIndex = parseInt(
                  K(s).attr("data-swiper-slide-index"),
                  10
                ))
              : (t.clickedIndex = n),
      ...
      transition: {
        ...
        transitionStart: function (e, t) {
          ...
          s.cssMode ||
            ...
            pe({ swiper: i, runCallbacks: e, direction: t, step: "Start" }));
        },
        transitionEnd: function (e, t) {
          ...
          (i.animating = !1),
            s.cssMode ||
              (i.setTransition(0),
              pe({ swiper: i, runCallbacks: e, direction: t, step: "End" }));
        },
      },
      slide: {
      ...
      loop: {
        loopCreate: function () {
          ...
          for (let e = 0; e < r.length; e += 1)
            n.append(K(r[e].cloneNode(!0)).addClass(i.slideDuplicateClass));
          for (let e = a.length - 1; e >= 0; e -= 1)
            n.prepend(K(a[e].cloneNode(!0)).addClass(i.slideDuplicateClass));
        },
        loopFix: function () {
          const e = this;
      ...
      events: {
        attachEvents: function () {
          ...
          (e.onTouchStart = fe.bind(e)),
            ...
            i.cssMode && (e.onScroll = ye.bind(e)),
            (e.onClick = be.bind(e)),
            s.touch && !xe && (t.addEventListener("touchstart", we), (xe = !0)),
            Ce(e, "on");
        },
    ...
    i({
      ...
      s("click", (e, i) => {
        const { $nextEl: s, $prevEl: o } = t.navigation,
          a = i.target;
        if (t.params.navigation.hideOnClick && !K(a).is(o) && !K(a).is(s)) {
          if (
            t.pagination &&
            t.params.pagination &&
  ...
  function Oe(e) {
    ...
    function d() {
      ...
      if (
        ("fraction" === i.type &&
          (o.find(Ae(i.currentClass)).text(i.formatFractionCurrent(d + 1)),
          o.find(Ae(i.totalClass)).text(i.formatFractionTotal(h))),
        "progressbar" === i.type)
      ) {
        let e;
        ...
        "horizontal" === e ? (n = s) : (a = s),
          o
            .find(Ae(i.progressbarFillClass))
    ...
    function h() {
      ...
      if ("bullets" === e.type) {
        ...
        s.html(o), (t.pagination.bullets = s.find(Ae(e.bulletClass)));
      }
      "fraction" === e.type &&
        ((o = e.renderFraction
    ...
    function u() {
      ...
      0 !== i.length &&
        ...
        e.clickable &&
          i.on("click", Ae(e.bulletClass), function (e) {
            e.preventDefault();
    ...
    function p() {
      ...
      i.removeClass(e.hiddenClass),
        ...
        e.clickable && i.off("click", Ae(e.bulletClass));
    }
    s("init", () => {
      u(), h(), d();
    }),
      ...
      s("click", (e, i) => {
        ...
        if (
          ...
          o.length > 0 &&
          !K(s).hasClass(t.params.pagination.bulletClass)
        ) {
          if (
            t.navigation &&
  ...
  function _e(e) {
        ...
        0 !== a.length &&
          a.each((e) => {
            ...
            const l = a.attr("data-background"),
              ...
              h = a.attr("data-sizes"),
              u = a.parent("picture");
            t.loadImage(a[0], c || l, d, h, !1, () => {
              if (null != t && t && (!t || t.params) && !t.destroyed) {
                if (
                  (l
                    ? (a.css("background-image", `url("${l}")`),
                      a.removeAttr("data-background"))
                    : (d && (a.attr("srcset", d), a.removeAttr("data-srcset")),
    ...
    function l() {
      ...
      function h(e) {
        return o ? K(e).attr("data-swiper-slide-index") : K(e).index();
      }
      if (
        ("auto" === c && (c = 0), a || (a = !0), t.params.watchSlidesProgress)
      )
        e.children(`.${i.slideVisibleClass}`).each((e) => {
          r(o ? K(e).attr("data-swiper-slide-index") : K(e).index());
        });
      else if (c > 1) for (let e = n; e < n + c; e += 1) d(e) && r(e);
      else r(n);
      if (l.loadPrevNext)
        if (c > 1 || (l.loadPrevNextAmount && l.loadPrevNextAmount > 1)) {
          ...
          for (let e = n + c; e < i; e += 1) d(e) && r(e);
          for (let e = o; e < n; e += 1) d(e) && r(e);
        } else {
    ...
    function c() {
      ...
      h ? (l(), i.off("scroll", c, p)) : o || ((o = !0), i.on("scroll", c, p));
    }
    s("beforeInit", () => {
  ...
  function Ie(e) {
    ...
    function p(e) {
      ...
      t.navigation &&
        ...
        t.isEnd ? o(i.lastSlideMessage) : o(i.nextSlideMessage)),
        t.navigation &&
          t.navigation.$prevEl &&
          s.is(t.navigation.$prevEl) &&
          ((t.isBeginning && !t.params.loop) || t.slidePrev(),
          t.isBeginning ? o(i.firstSlideMessage) : o(i.prevSlideMessage)),
        t.pagination &&
          s.is(Ae(t.params.pagination.bulletClass)) &&
          s[0].click();
    }
    function f() {
      return (
    ...
    function b() {
      ...
      (h = o),
        ...
        e.itemRoleDescriptionMessage &&
          c(K(t.slides), e.itemRoleDescriptionMessage),
        l(K(t.slides), e.slideRole);
      ...
      t.slides.each((i, s) => {
        ...
        f && f.length && m(f, o, e.nextSlideMessage),
        b && b.length && m(b, o, e.prevSlideMessage),
        g() &&
          t.pagination.$el.on(
            "keydown",
      ...
      s("fromEdge toEdge afterInit lock unlock", () => {
        t.params.a11y.enabled &&
          (function () {
            ...
            const { $nextEl: e, $prevEl: i } = t.navigation;
            i && i.length > 0 && (t.isBeginning ? (h(i), r(i)) : (u(i), a(i))),
              e && e.length > 0 && (t.isEnd ? (h(e), r(e)) : (u(e), a(e)));
          })();
      }),
      s("paginationUpdate", () => {
        t.params.a11y.enabled &&
  ...
  const Ne = {
    MixinCarousel: {
      ...
      on: {
        init(e) {
          e.$el.removeClass("opacity-0"), e.$el.addClass("opacity-100");
        },
      },
    },
    BlockImageCarousel: {
      ...
      pagination: {
        ...
        renderBullet: function (e, t) {
          return `<button class="${t}" arial-label="Go to slide ${e}"><span></span></button>`;
        },
      },
    },
  };
  Object.assign(Ne, { BaseCarouselCards: Ne.MixinCarousel });
  var Be = Ne;
  new ke(".MixinCarousel .swiper, .BaseCarouselCards .swiper", {
    modules: [ze, _e, Ie, Oe],
    ...Be.MixinCarousel,
  }),
    new ke(".BlockImageCarousel .swiper", {
      modules: [ze, _e, Ie, Oe],
      ...Be.BlockImageCarousel,
    });
  const De = document.querySelector("#HeroMediaCaptionToggle"),
    Fe = document.querySelector("#HeroMediaCaption");
  De &&
    De.addEventListener("click", (e) => {
      De.classList.toggle("expanded"), Fe.classList.toggle("hidden");
    }),
      ...
      .forEach(function (e) {
        var t = e.hasAttribute("data-allow-multiple"),
          i = Array.prototype.slice.call(
            e.querySelectorAll(".BlockAccordion-trigger")
          );
        Array.prototype.slice.call(e.querySelectorAll(".BlockAccordion-panel"));
        e.addEventListener("click", function (i) {
          var s = i.target;
          if (s.classList.contains("BlockAccordion-trigger")) {
            var n = "true" == s.getAttribute("aria-expanded"),
              o = e.querySelector('[aria-expanded="true"]');
            if (!t && o && o !== s) {
              ...
              document
                .getElementById(o.getAttribute("aria-controls"))
                .setAttribute("hidden", "");
            }
            if (n) {
              if (n) {
          ...
          e.addEventListener("keydown", function (e) {
            var t = e.target,
              ...
              n =
                ...
                e.ctrlKey && s.match(/33|34/));
            if (t.classList.contains("BlockAccordion-trigger"))
              if (s.match(/38|40/) || n) {
                var o = i.indexOf(t),
                  a = s.match(/34|40/) ? 1 : -1,
                  r = i.length;
                i[(o + r + a) % r].focus(), e.preventDefault();
              } else if (s.match(/35|36/)) {
                switch (s) {
                  case "36":
                    i[0].focus();
                    break;
  ...
  let Re = null;
  const He = document.getElementById("HeaderInternal"),
    We = document.getElementById("NavBgOverlay"),
    Ge = document.getElementById("NavInternalContainer"),
    qe = document.getElementById("NavMobileToggle"),
    Ve = document.getElementById("NavMobileSearchInput"),
    je = (e) => {
      const t = e.parentElement;
      document.body.classList.toggle("lg:overflow-hidden"),
        We.classList.toggle("invisible-overlay"),
    ...
    Xe = (e) => {
      if (Re) {
        document.getElementById("target_" + Re.id).contains(e.target) ||
          (je(Re), (Re = null));
      }
    },
    Ye = (e) => {
      document.body.classList.remove("overflow-hidden", "lg:overflow-hidden"),
        We.classList.add("invisible-overlay"),
        He.classList.remove("h-screen"),
        He.classList.remove("overflow-y-scroll"),
        Ge.classList.add("hidden"),
        qe.classList.remove("expanded"),
        qe.setAttribute("aria-label", "Open menu"),
        Re &&
          (Re.parentElement.classList.remove("expanded"),
          Re.setAttribute("aria-expanded", "false"),
          (Re = null));
    },
    Ue = document.getElementById("NavSearchOpen"),
    Ze = document.getElementById("NavSearchClose"),
    Ke = document.getElementById("NavSearchContainer"),
    Je = document.getElementById("NavSearchInput"),
    Qe = (e) => {
      Ke && Je && (Ke.classList.remove("lg:block"), (Je.value = ""));
    };
  Ue &&
    Ue.addEventListener("click", (e) => {
      Ke && Je && (Ke.classList.add("lg:block"), Je.focus());
    }),
    Ze && Ze.addEventListener("click", Qe),
    document.addEventListener("click", (e) => {
      qe && qe.contains(e.target)
        ? (He.classList.toggle("h-screen"),
          He.classList.toggle("overflow-y-scroll"),
          Ge.classList.toggle("hidden"),
          qe.classList.toggle("expanded"),
          qe.classList.contains("expanded")
            ? qe.setAttribute("aria-label", "Close menu")
            : ((Ve.value = ""), qe.setAttribute("aria-label", "Open menu")),
          document.body.classList.toggle("overflow-hidden"),
          Xe(e))
        : e.target.classList &&
          e.target.classList.contains("toggle-NavInternalPanel")
        ? ((e) => {
            je(e), Re ? (Re == e ? (Re = null) : (je(Re), (Re = e))) : (Re = e);
          })(e.target)
        : Re && Xe(e);
    }),
  ...
  const et = (e) => {
    const t = e.querySelector("button"),
      i = parseFloat(e.dataset.threshold) || 300,
      s = parseFloat(e.dataset.scrollto) || 0,
      n = e.dataset.alwaysvisible,
      o = ((e, t = 0) => {
        let i;
        return (...s) => {
          clearTimeout(i),
  ...
  document.addEventListener("DOMContentLoaded", () => {
    document.querySelectorAll(".BackToTop").forEach(et);
  });
})();
